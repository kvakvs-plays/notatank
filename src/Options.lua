	...
	optionTable.args.reminders = {
		...
		args = {
			...
			blessingOfWisdom = {
				...
				desc = "Allow Blessing of Wisdom as a self-buff reminder.",
				order = 141,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "blessingOfWisdom"),
				set = setReminderSpell("shouts", "blessingOfWisdom"),
			},
			blessingOfMight = {
				type = "toggle",
				name = "Blessing of Might",
				desc = "Allow Blessing of Might as a self-buff reminder.",
				order = 142,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "blessingOfMight"),
				set = setReminderSpell("shouts", "blessingOfMight"),
			},
			blessingOfSanctuary = {
				type = "toggle",
				name = "Blessing of Sanctuary",
				desc = "Allow Blessing of Sanctuary as a self-buff reminder.",
				order = 143,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "blessingOfSanctuary"),
				set = setReminderSpell("shouts", "blessingOfSanctuary"),
			},
			blessingOfKings = {
				type = "toggle",
				name = "Blessing of Kings",
				desc = "Allow Blessing of Kings as a self-buff reminder.",
				order = 144,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "blessingOfKings"),
				set = setReminderSpell("shouts", "blessingOfKings"),
			},
			sanctityAura = {
				type = "toggle",
				name = "Sanctity Aura",
				desc = "Allow Sanctity Aura as a self-buff reminder.",
				order = 145,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "sanctityAura"),
				set = setReminderSpell("shouts", "sanctityAura"),
			},
			devotionAura = {
				type = "toggle",
				name = "Devotion Aura",
				desc = "Allow Devotion Aura as a self-buff reminder.",
				order = 146,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "devotionAura"),
				set = setReminderSpell("shouts", "devotionAura"),
			},
			retributionAura = {
				type = "toggle",
				name = "Retribution Aura",
				desc = "Allow Retribution Aura as a self-buff reminder.",
				order = 147,
				hidden = hiddenForClass("PALADIN"),
				get = getReminderSpell("shouts", "retributionAura"),
				set = setReminderSpell("shouts", "retributionAura"),
			},
			rogueHeader = {
				type = "header",
				name = "Rogue",
